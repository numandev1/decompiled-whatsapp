...
public abstract class Hilt_RestorePasswordInputFragment extends PasswordInputFragment {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.whatsapp.backup.encryptedbackup.Hilt_RestorePasswordInputFragment */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.whatsapp.backup.encryptedbackup.Hilt_RestorePasswordInputFragment */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.whatsapp.backup.encryptedbackup.Hilt_PasswordInputFragment
    ...
    public void A0y() {
        if (!this.A01) {
            this.A01 = true;
            ((AbstractC02250At) generatedComponent()).A0f((RestorePasswordInputFragment) this);
        }
    }
}
